...
import com.example.agriconnect.databinding.FragmentMarketPlaceLayoutBinding
...
class Market_Place_Layout : Fragment() {
    ...
    private lateinit var Farmer_Market_Place_ViewModel : Farmer_Shop_ViewModel

    private lateinit var recyclerView: RecyclerView
    private lateinit var adapter: Adapter_Market_Place
    private lateinit var dataList_Products: ArrayList<FarmerProduct>
...
//        return inflater.inflate(R.layout.fragment_market__place__layout, container, false)
        ...
        Farmer_Market_Place_ViewModel = ViewModelProvider(requireActivity()).get(Farmer_Shop_ViewModel::class.java)
...
//                Farmer_Market_Place_ViewModel.setData4(datalist1[position].product_price)
        ...
        while(a < count+1) {
            ...
            docRef.get().addOnSuccessListener { documentSnapshot ->
                if (documentSnapshot.exists()) {
                    val data =
                        documentSnapshot.toObject<FarmerProduct>(
                            FarmerProduct::class.java
                        )
    ...
    private fun dataInitialize(){
        dataList_Products = arrayListOf<FarmerProduct>()
    ...
    fun add1(datalist2: ArrayList<FarmerProduct> ) {
